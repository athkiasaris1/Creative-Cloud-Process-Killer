...
if %isprerel% == 1 (echo     ***This is a PRERELEASE VERSION of CCPK***) else (echo[)
echo[
echo[
echo[
echo[
...
cls
title Creative Cloud Process Killer
if %isprerel% == 1 (echo           **CCPK - PRERELEASE %version%**) else (echo[)
echo[
echo            --------------------------
echo           ^|                          ^|
...
echo           ^|      Process Killer      ^|
echo           ^|                          ^|
if %isprerel% == 0 (if %dot_count_currentver% == 2 (echo           ^|      Version: %version%      ^|) else (echo           ^|       Version: %version%       ^|)) else (if %dot_count_currentver% == 2 (echo           ^|    Version: %version%    ^|) else (echo           ^|     Version: %version%     ^|))
echo           ^|                          ^|
...
echo           ^|                          ^|
if %isprerel% == 0 (if %dot_count_currentver% == 2 (echo           ^|    Your Version: %version%   ^|) else echo           ^|     Your Version: %version%    ^|) else (if %dot_count_currentver% == 2 (echo           ^|  Your Version: %version% ^|) else echo           ^|   Your Version: %version%  ^|)
echo           ^|                          ^|
...
if !dot_count_preupdatever! == 2 (echo           ^|PreRel. Version: !preupdatecheckcurrent!^|) else if !dot_count_preupdatever! == 1 (echo           ^| PreRel. Version: !preupdatecheckcurrent! ^| ) else (echo           ^| PreRelease Version: !preupdatecheckcurrent! ^| )
echo           ^|                          ^|
